...
const Home = () => {
    return (
        <div className={style.home}>
            ...
            <Pedido titulo_pedido={"Fome de comida de verdade ?"} alt={"Ícone de Telefone"} src={Phone} desc_pedido={" Peçca agora pelos nossos canais exclusivos e receba descontos especias na sua primeira entrega."} texto={"Pedir via WhatsApp"} tipo={1} estiloBtn={style.btn_fome_pedido} />
        </div>
    );
}
